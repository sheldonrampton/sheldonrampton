...
"linktrail"		=> "/^([a-z]+)(.*)\$/sD",
"mainpage"		=> "Steal This Mouse",    # CHANGED -- Sheldon
...
"recentchangestext" => "Track the most recent changes to $wgSitename on this page.<br>
<b>Questions? See [[$wgMetaNamespace:Article guidelines|$wgMetaNamespace article guidelines]], 
[[$wgMetaNamespace:Manual of Style|manual of style]] and [[$wgMetaNamespace:Help|help]].</b>",    # CHANGED -- Sheldon
